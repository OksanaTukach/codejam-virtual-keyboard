...
information.textContent = "Смена языка:Alt + Shift";

textarea.name = 'text';
textarea.rows = '7';
textarea.cols = '50';
textarea.classList.add('textarea');
root.append(textarea, keyboard, information);
...
keyboardArr2[14].style.width = '55px';
keyboardArr2[0].style.width = '55px';
keyboardArr3[0].style.width = '100px';
keyboardArr3[12].style.width = '85px';
keyboardArr4[0].style.width = '100px';
keyboardArr4[12].style.width = '110px';
keyboardArr5[3].style.width = '350px';
...
document.onkeydown = function () { return !event.keyCode; };
